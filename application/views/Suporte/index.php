<div class="row">
  <div class="col-md-12">
        <table class="table">
            <thead>
                <tr>
                    <?php  foreach ($c_campos as $resultCamposTable): ?>
                    <?php //echo '<pre>'; print_r($resultCamposTable) ?>
                        ...
                        <?php else: ?>	<td align="center"><?= _string(str_replace('slug' , $c_replace , $resultCamposTable->name )); ?></td> <?php endif ?>
                    <?php endforeach; ?>
                    <td>Ações</td>
                </tr>
            </thead>
            ...
            <?php foreach ($w_dados as $resultData): //CONTEUDO DO BANCO ?>
                <tr>
                    <?php foreach ($c_campos as $resultCampos):  $_dados = strval($resultCampos->name); //CONVERTENDO ARRAY PRA STRING  ?>
                    ...
                    <?php endforeach ?>
                    <td>
                        <a href="<?= BaseController($c_class , 'view' , $resultData->id , 'dashboard') ?>">Abrir</a>
                    </td>
                </tr>
            <?php endforeach ?>
            </tbody>
